...
public class EditTextReaction {
    public static void ButtonReaction(EditText editText1, Button button1){//EditText输入内容后让按钮颜色变化并且可点击
    ...
    public static void EditTextSize(EditText editText1,SpannableString string1,int textsize){//设置EditText中的hint文字大小
