...
public class Login2Activity extends AppCompatActivity {
   ...
   // private String loginemail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TokenInterceptor.getContext(Login2Activity.this);
    ...
    public  void showResponse(final String condition){
        runOnUiThread(new Runnable(){
            @Override
            public void run(){
                Toast.makeText(Login2Activity.this, condition, Toast.LENGTH_SHORT).show();
            }
        });
    }

    public static Intent newIntent(Context packageContext, String email){
        Intent intent = new Intent(packageContext, Login2Activity.class);
