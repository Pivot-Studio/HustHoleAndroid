package cn.pivotstudio.modulep.hole.ui.custom_view
...
import cn.pivotstudio.moduleb.rebase.lib.base.custom_view.MaxHeightRecyclerView
import cn.pivotstudio.modulep.hole.R
import cn.pivotstudio.modulep.hole.ui.activity.PublishHoleActivity
import cn.pivotstudio.modulep.hole.ui.adapter.ChooseForestAdapter
...
class ForestsPopupWindow(
    ...
    private fun onClick(v: View) {
        ...
        if (id == R.id.btn_publishholeforests_chooseforest) {
            ...
            )[cn.pivotstudio.modulep.hole.viewmodel.PublishHoleViewModel::class.java]
