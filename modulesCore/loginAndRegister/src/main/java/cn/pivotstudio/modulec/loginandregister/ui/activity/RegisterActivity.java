...
public class RegisterActivity extends BaseActivity {
    ...
    private void initView(){
        ...
        EditTextUtil.EditTextSize(mRegisterEmailHeadEt,new SpannableString(this.getResources().getString(R.string.login_id_2)),14);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_register_jumptosetpassword) {//下一步设置密码
            ...
            if (Character.isUpperCase(mEmailHead.charAt(0)) || Character.isLowerCase(mEmailHead.charAt(0))) {//判断学号是否正确
