...
public class RegisterActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        Button mRegisterJumpToSetPasswordBtn = findViewById(R.id.btn_next);
        mRegisterEmailHeadEt = findViewById(R.id.et_register_student_code);
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.tv_register_had_registered) {//已经注册
