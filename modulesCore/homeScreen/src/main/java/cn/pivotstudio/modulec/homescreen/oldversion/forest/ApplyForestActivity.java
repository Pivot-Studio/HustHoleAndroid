                    ...
                    if(response.code()==200) {
                        ...
                        if (response.errorBody() != null) {
                            try {
                                ...
                                Toast.makeText(ApplyForestActivity.this, json, Toast.LENGTH_SHORT).show();
                            } catch (IOException  e) {
                                e.printStackTrace();
                            }
                        }else{
                            Toast.makeText(ApplyForestActivity.this, R.string.network_unknownfailture,Toast.LENGTH_SHORT).show();
                        }
                    }
                }
       ...
       // File file = new File(extDir,fileName);
        if (ContextCompat.checkSelfPermission(ApplyForestActivity.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(ApplyForestActivity.this,
                ...
                ActivityCompat.requestPermissions(ApplyForestActivity.this,
