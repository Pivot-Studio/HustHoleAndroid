...
//    ) {
//        viewModelScope.launch {
//            repository.sendEvaluation(score + 1)
//                .collect {
//                    when(it) {
//                        is ApiResult.Success<*> -> {
//                            val chip = (binding.chipGroup.getChildAt(score - 1) as Chip)
//                            Toast.makeText(context, "感谢亲的评分(づ￣3￣)づ╭❤～"  + score.toString(), Toast.LENGTH_SHORT).show()
...
//    ) {
//        viewModelScope.launch {
//            repository.sendAdvice(content, fromValue(binding.chipGroup2[binding.chipGroup2.checkedChipId].transitionName))
//                .collect {
//                    when(it) {
//                        is Success<*> -> {
