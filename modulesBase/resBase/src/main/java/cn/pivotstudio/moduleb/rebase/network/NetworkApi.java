...
import cn.pivotstudio.moduleb.rebase.network.errorhandler.ExceptionHandler;
import cn.pivotstudio.moduleb.rebase.network.errorhandler.HttpErrorHandler;
import cn.pivotstudio.moduleb.rebase.network.interceptor.RequestInterceptor;
import cn.pivotstudio.moduleb.rebase.network.interceptor.ResponseInterceptor;
...
//            builder.addInterceptor(new TokenInterceptor(iNetworkRequiredInfo.getApplicationContext()));
     ...
     * {@link NetworkApi#applySchedulers()}
     */
    @Deprecated
